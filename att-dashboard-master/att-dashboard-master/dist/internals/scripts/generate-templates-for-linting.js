...
function runLintingOnDirectory(relativePath) {
    return new Promise((resolve, reject) => {
        shell.exec(`npm run lint:eslint "app/${relativePath}/**/**.js"`, {
            silent: true,
        }, code => code
...
function runLintingOnFile(filePath) {
    return new Promise((resolve, reject) => {
        shell.exec(`npm run lint:eslint "${filePath}"`, {
            silent: true,
        }, code => {
            if (code) {
 ...
 * @returns {Promise<*>}
 */
function restoreModifiedFile(filePath, backupFileExtension = BACKUPFILE_EXTENSION) {
 ...
 */
function generateComponent({ name, memo }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield runLintingOnDirectory(relativePath)
            .then(reportSuccess(`Linting test passed for '${component}'`))
            .catch(reason => reportErrors(reason));
        yield removeDir(relativePath)
 ...
 */
function generateContainer({ name, memo }) {
    return __awaiter(this, void 0, void 0, function* () {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const promises = components.map((component) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (component.kind === 'component') {
                result = yield generateComponent(component);
            }
            else if (component.kind === 'container') {
                result = yield generateContainer(component);
            }
            return result;
        }));
...
function generateLanguage(language) {
    return __awaiter(this, void 0, void 0, function* () {
        // Run generator
        const generatedFiles = yield languageGen
...
(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield generateLanguage('fr').catch(reason => reportErrors(reason));
    });
})();
